...
import { ChatIcon, Leftarrow, Progressbar } from "../components/Svglist";
    ...
    <div className="flex flex-col xl:flex-row min-h-[100vh] bg-bg bg-cover bg-no-repeat w-full overflow-x-hidden">
      ...
      <div className="px-6 mt-[80px] xl:mt-[100px] flex justify-center">
        <div className="md:w-[calc(100%-300px)] w-full xl:w-[480px] mx-auto ml-0 xl:ml-[60px] md:mr-[300px] xl:mr-0">
          ...
          <div className="flex flex-col border-[1px] bg-[#04134A] border-[#FFFFFF24] rounded-3xl px-6">
            ...
            <div className="flex flex-row mt-[13px] items-center gap-3">
              <input
                ...
                className="w-[calc(100%-118px)] h-12 border-[1px] bg-[#05104C] pl-5 border-white-10 rounded-xl text-[16px] text-[#FFFFFF54]"
              />
              <button
      ...
      <div className="mr-[328px] ml-6 xl:mr-[300px] xl:w-[calc(100%-840px)] md:w-[calc(100%-348px)] w-[calc(100%-48px)]">
